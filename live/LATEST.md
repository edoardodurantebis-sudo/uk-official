...
Last heartbeat UTC: `2026-09-17T15:39:44.652074Z`  
Current process started UTC: `2026-09-17T15:35:42.919261Z`  
...
- `FUELINST|fuelType=INTVKL|generation` = **-433** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=NPSHYD|generation` = **365** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=NUCLEAR|generation` = **3310** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=OCGT|generation` = **57** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=OIL|generation` = **0** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=OTHER|generation` = **781** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=PS|generation` = **-324** (n=769, 2026-09-17T15:35:42.919268Z)
- `FUELINST|fuelType=WIND|generation` = **13640** (n=769, 2026-09-17T15:35:42.919268Z)
...
- `2026-09-17T15:39:42.767284Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:41.208625Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:39.665001Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:38.117374Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:36.564835Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:35.024950Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:33.470696Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:31.912223Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:30.368235Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:28.795540Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:26.854879Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:25.314818Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:23.775184Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:22.223624Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
- `2026-09-17T15:39:20.671154Z` — **MID**: 0 rows; marker `2026-09-17T15:35:00Z`; ERROR=RuntimeError: MID: HTTP Error 400: Bad Request
