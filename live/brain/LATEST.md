...
Heartbeat: `2026-09-20T09:58:30.191401Z`  
Memory snapshots: **1793**  
...
- **PERSISTENT_UP** `margin` value=3.929e+04 d1=0.0 d12=1799.0 z=27.1022245
...
- **CHANGE_POINT** `wind_gen` value=1.442e+04 d1=-220.0 d12=-598.0 z=-2.0006970880225077
- **REVERSAL** `ccgt_gen` value=2287 d1=3.0 d12=-99.0 z=-3.7638695085341367
- **ROBUST_OUTLIER** `ccgt_gen` value=2287 d1=3.0 d12=-99.0 z=-3.7638695085341367
- **REVERSAL** `thermal_base` value=5627 d1=5.0 d12=-97.0 z=-3.7387548066132266
...
- `2026-09-20T07:39:23.525158Z` distance=0.456 → {'next30m_imbalance_delta': 0.0, 'next30m_margin_delta': 0.0, 'next30m_residual_proxy_delta': 1162.0}
