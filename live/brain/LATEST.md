...
Heartbeat: `2026-09-19T18:33:57.936377Z`  
Memory snapshots: **1574**  
...
- **PERSISTENT_DOWN** `ind_generation` value=1.62e+04 d1=0.0 d12=-614.0 z=-38.918058574999996
...
- **PERSISTENT_DOWN** `imbalance` value=-3750 d1=0.0 d12=-614.0 z=-10.223844631578947
...
- **PERSISTENT_UP** `ccgt_gen` value=7000 d1=113.0 d12=195.0 z=4.166515630193906
- **ROBUST_OUTLIER** `ccgt_gen` value=7000 d1=113.0 d12=195.0 z=4.166515630193906
- **PERSISTENT_UP** `thermal_base` value=1.033e+04 d1=112.0 d12=194.0 z=4.140995786238532
- **ROBUST_OUTLIER** `thermal_base` value=1.033e+04 d1=112.0 d12=194.0 z=4.140995786238532
- **CHANGE_POINT** `biomass_gen` value=895 d1=16.0 d12=287.0 z=1.9058976422018348
- **PERSISTENT_UP** `biomass_gen` value=895 d1=16.0 d12=287.0 z=1.9058976422018348
- **PERSISTENT_UP** `interconnector_net` value=-1195 d1=910.0 d12=1780.0 z=1.3399163421145686
- **ACCELERATION** `interconnector_net` value=-1195 d1=910.0 d12=1780.0 z=1.3399163421145686
