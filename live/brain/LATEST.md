...
Heartbeat: `2026-09-23T04:01:55.040392Z`  
...
- **PERSISTENT_DOWN** `biomass_gen` value=2867 d1=0.0 d12=-15.0 z=-4.0469385
- **ROBUST_OUTLIER** `biomass_gen` value=2867 d1=0.0 d12=-15.0 z=-4.0469385
- **CHANGE_POINT** `wind_gen` value=7373 d1=80.0 d12=1642.0 z=1.871421757208388
- **CHANGE_POINT** `ps_gen` value=144 d1=0.0 d12=156.0 z=-1.1241495833333335
...
- **PERSISTENT_UP** `ind_demand` value=-1.24e+04 d1=0.0 d12=15.0 z=3.077359484375
- **ROBUST_OUTLIER** `ind_demand` value=-1.24e+04 d1=0.0 d12=15.0 z=3.077359484375
- **PERSISTENT_UP** `wind_gen` value=7373 d1=80.0 d12=1642.0 z=1.871421757208388
