...
Heartbeat: `2026-09-18T00:00:29.495993Z`  
Memory snapshots: **1023**  
...
- **ACCELERATION** `imbalance` value=1.014e+04 d1=0.0 d12=425.0 z=18.422001296875
...
- **ACCELERATION** `ind_generation` value=2.695e+04 d1=0.0 d12=425.0 z=18.422001296875
...
- **CHANGE_POINT** `biomass_gen` value=1960 d1=0.0 d12=197.0 z=-2.036217338058419
- **CHANGE_POINT** `wind_gen` value=1.427e+04 d1=0.0 d12=-846.0 z=-1.997669095628415
- **CHANGE_POINT** `ps_gen` value=56 d1=0.0 d12=1.0 z=-0.8766422975504322
- **CHANGE_POINT** `margin` value=3.652e+04 d1=0.0 d12=11.0 z=0.12365645416666667
- **PERSISTENT_DOWN** `wind_gen` value=1.427e+04 d1=0.0 d12=-846.0 z=-1.997669095628415
