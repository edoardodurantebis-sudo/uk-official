...
Heartbeat: `2026-09-19T08:01:30.536514Z`  
Memory snapshots: **1424**  
...
- **PERSISTENT_DOWN** `ps_gen` value=-685 d1=-264.0 d12=-493.0 z=-24.1130085625
- **ACCELERATION** `ps_gen` value=-685 d1=-264.0 d12=-493.0 z=-24.1130085625
- **ROBUST_OUTLIER** `ps_gen` value=-685 d1=-264.0 d12=-493.0 z=-24.1130085625
- **CHANGE_POINT** `interconnector_net` value=-3224 d1=619.0 d12=2707.0 z=20.778069012024048
- **PERSISTENT_UP** `interconnector_net` value=-3224 d1=619.0 d12=2707.0 z=20.778069012024048
- **ROBUST_OUTLIER** `interconnector_net` value=-3224 d1=619.0 d12=2707.0 z=20.778069012024048
...
- **PERSISTENT_UP** `wind_gen` value=1.572e+04 d1=4.0 d12=12.0 z=-0.8007311470588235
...
- `2026-09-15T02:19:46.344592Z` distance=1.059 → {'next30m_imbalance_delta': 3.0, 'next30m_margin_delta': 0.0, 'next30m_residual_proxy_delta': 0.0}
