...
Heartbeat: `2026-09-16T07:40:08.214272Z`  
Memory snapshots: **486**  
...
- **PERSISTENT_UP** `interconnector_net` value=9784 d1=0.0 d12=6198.0 z=2.593695245816733
- **CHANGE_POINT** `imbalance` value=6872 d1=0.0 d12=-318.0 z=-0.342999906996587
- **ACCELERATION** `biomass_gen` value=3229 d1=0.0 d12=-3.0 z=-1.0117346249999999
- **PERSISTENT_UP** `ps_gen` value=226 d1=0.0 d12=4.0 z=1.0117346249999999
- **ACCELERATION** `ps_gen` value=226 d1=0.0 d12=4.0 z=1.0117346249999999
- **PERSISTENT_DOWN** `nuclear_gen` value=3327 d1=0.0 d12=-2.0 z=-0.67448975
- **ACCELERATION** `nuclear_gen` value=3327 d1=0.0 d12=-2.0 z=-0.67448975
...
- `2026-09-16T06:37:20.897017Z` distance=1.257 → {'next30m_imbalance_delta': 124.0, 'next30m_margin_delta': -45.0, 'next30m_residual_proxy_delta': 0.0}
