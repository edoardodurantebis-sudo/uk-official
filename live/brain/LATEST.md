...
Heartbeat: `2026-09-18T04:09:54.236691Z`  
Memory snapshots: **1082**  
...
- **CHANGE_POINT** `biomass_gen` value=2130 d1=0.0 d12=376.0 z=2.2464410681818183
- **CHANGE_POINT** `ind_demand` value=-1.125e+04 d1=0.0 d12=-6.0 z=-1.6083986346153847
- **CHANGE_POINT** `interconnector_net` value=-6907 d1=0.0 d12=-712.0 z=-1.2986444440298506
- **PERSISTENT_UP** `biomass_gen` value=2130 d1=0.0 d12=376.0 z=2.2464410681818183
- **PERSISTENT_DOWN** `ccgt_gen` value=3307 d1=0.0 d12=-145.0 z=-1.3460212116228072
- **ACCELERATION** `ccgt_gen` value=3307 d1=0.0 d12=-145.0 z=-1.3460212116228072
- **PERSISTENT_DOWN** `thermal_base` value=6644 d1=0.0 d12=-134.0 z=-1.326446434855234
- **ACCELERATION** `thermal_base` value=6644 d1=0.0 d12=-134.0 z=-1.326446434855234
- **PERSISTENT_DOWN** `interconnector_net` value=-6907 d1=0.0 d12=-712.0 z=-1.2986444440298506
