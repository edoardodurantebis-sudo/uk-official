...
Heartbeat: `2026-09-15T12:30:36.484168Z`  
Memory snapshots: **213**  
...
- **CHANGE_POINT** `ind_generation` value=2.475e+04 d1=0.0 d12=-1.0 z=10.28707079493464
- **ROBUST_OUTLIER** `ts_demand_forecast` value=1.91e+04 d1=0.0 d12=0.0 z=-10.950539470588234
- **ACCELERATION** `ind_generation` value=2.475e+04 d1=0.0 d12=-1.0 z=10.28707079493464
- **ROBUST_OUTLIER** `ind_generation` value=2.475e+04 d1=0.0 d12=-1.0 z=10.28707079493464
- **ROBUST_OUTLIER** `demand_forecast` value=1.86e+04 d1=0.0 d12=0.0 z=-6.6449730925925925
- **CHANGE_POINT** `wind_gen` value=1.08e+04 d1=-162.0 d12=-417.0 z=-1.4266061975703326
- **PERSISTENT_DOWN** `margin` value=3.518e+04 d1=0.0 d12=-340.0 z=3.3404824111374407
- **ROBUST_OUTLIER** `margin` value=3.518e+04 d1=0.0 d12=-340.0 z=3.3404824111374407
- **PERSISTENT_DOWN** `residual_proxy` value=756 d1=-249.0 d12=-249.0 z=-3.155063532560707
- **ACCELERATION** `residual_proxy` value=756 d1=-249.0 d12=-249.0 z=-3.155063532560707
- **ROBUST_OUTLIER** `residual_proxy` value=756 d1=-249.0 d12=-249.0 z=-3.155063532560707
- **CHANGE_POINT** `ccgt_gen` value=1470 d1=12.0 d12=9.0 z=-0.8302884606980704
- **CHANGE_POINT** `thermal_base` value=4802 d1=12.0 d12=16.0 z=-0.8110615606316977
