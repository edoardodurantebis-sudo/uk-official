...
Heartbeat: `2026-09-19T11:33:09.035060Z`  
Memory snapshots: **1474**  
...
- **CHANGE_POINT** `ps_gen` value=-933 d1=2.0 d12=-238.0 z=-2.2033331833333336
...
- **CHANGE_POINT** `margin` value=3.666e+04 d1=0.0 d12=149.0 z=-0.950602623489426
- **REVERSAL** `ps_gen` value=-933 d1=2.0 d12=-238.0 z=-2.2033331833333336
- **CHANGE_POINT** `ind_demand` value=-1.178e+04 d1=0.0 d12=1442.0 z=0.17693481117957746
- **REVERSAL** `thermal_base` value=6121 d1=5.0 d12=-127.0 z=-2.027877679738562
- **REVERSAL** `ccgt_gen` value=2787 d1=5.0 d12=-130.0 z=-1.9992228864379085
- **PERSISTENT_DOWN** `wind_gen` value=1.563e+04 d1=-48.0 d12=-198.0 z=-1.200920774390244
- **PERSISTENT_UP** `margin` value=3.666e+04 d1=0.0 d12=149.0 z=-0.950602623489426
- **PERSISTENT_UP** `biomass_gen` value=477 d1=0.0 d12=1.0 z=-0.6971889242788462
