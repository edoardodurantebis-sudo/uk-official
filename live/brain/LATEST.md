...
Heartbeat: `2026-09-17T11:43:34.659238Z`  
Memory snapshots: **848**  
...
- **CHANGE_POINT** `ind_generation` value=2.852e+04 d1=0.0 d12=1967.0 z=33.033546780487804
- **ROBUST_OUTLIER** `ind_generation` value=2.852e+04 d1=0.0 d12=1967.0 z=33.033546780487804
- **CHANGE_POINT** `imbalance` value=1.198e+04 d1=0.0 d12=5286.0 z=22.372160017605633
- **ROBUST_OUTLIER** `imbalance` value=1.198e+04 d1=0.0 d12=5286.0 z=22.372160017605633
...
- **CHANGE_POINT** `margin` value=3.709e+04 d1=0.0 d12=276.0 z=3.7691231889596604
...
- **ROBUST_OUTLIER** `margin` value=3.709e+04 d1=0.0 d12=276.0 z=3.7691231889596604
- **CHANGE_POINT** `ind_demand` value=-1.126e+04 d1=0.0 d12=1771.0 z=0.8646278100890208
- **CHANGE_POINT** `wind_gen` value=1.506e+04 d1=-67.0 d12=-586.0 z=-0.38381678630952376
- **PERSISTENT_DOWN** `nuclear_gen` value=3304 d1=0.0 d12=-7.0 z=-2.02346925
- **ACCELERATION** `nuclear_gen` value=3304 d1=0.0 d12=-7.0 z=-2.02346925
