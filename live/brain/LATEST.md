...
Heartbeat: `2026-09-22T00:26:18.968752Z`  
Memory snapshots: **2338**  
...
- **ACCELERATION** `imbalance` value=-1960 d1=0.0 d12=56.0 z=3.098156251666667
...
- **ACCELERATION** `ind_generation` value=1.95e+04 d1=0.0 d12=56.0 z=3.098156251666667
- **ROBUST_OUTLIER** `ind_generation` value=1.95e+04 d1=0.0 d12=56.0 z=3.098156251666667
- **CHANGE_POINT** `ps_gen` value=-285 d1=0.0 d12=0.0 z=-1.0916875098039216
- **CHANGE_POINT** `biomass_gen` value=3005 d1=-1.0 d12=1.0 z=-0.3194951447368421
- **REVERSAL** `thermal_base` value=1.488e+04 d1=21.0 d12=-37.0 z=-1.3864768711393274
- **ACCELERATION** `thermal_base` value=1.488e+04 d1=21.0 d12=-37.0 z=-1.3864768711393274
- **REVERSAL** `ccgt_gen` value=1.122e+04 d1=20.0 d12=-37.0 z=-1.271848068734793
