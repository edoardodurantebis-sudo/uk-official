...
Heartbeat: `2026-09-20T09:36:54.599847Z`  
Memory snapshots: **1788**  
...
- **CHANGE_POINT** `margin` value=3.889e+04 d1=0.0 d12=1436.0 z=20.9858288125
...
- **PERSISTENT_DOWN** `ccgt_gen` value=2274 d1=-13.0 d12=-419.0 z=-4.675252912591687
- **ROBUST_OUTLIER** `ccgt_gen` value=2274 d1=-13.0 d12=-419.0 z=-4.675252912591687
- **PERSISTENT_DOWN** `thermal_base` value=5611 d1=-10.0 d12=-418.0 z=-4.533534676785714
- **ROBUST_OUTLIER** `thermal_base` value=5611 d1=-10.0 d12=-418.0 z=-4.533534676785714
- **PERSISTENT_DOWN** `interconnector_net` value=-4457 d1=0.0 d12=-1212.0 z=1.9912527680386178
- **ACCELERATION** `interconnector_net` value=-4457 d1=0.0 d12=-1212.0 z=1.9912527680386178
- **PERSISTENT_DOWN** `wind_gen` value=1.489e+04 d1=-5.0 d12=-190.0 z=-1.0828857735849056
